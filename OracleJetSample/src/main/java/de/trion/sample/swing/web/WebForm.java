...
public class WebForm extends JPanel
{
    ...
    public void navigate(String target)
    {
        Platform.runLater(() ->
        {
            webView.getEngine().executeScript("window.location.hash = '#?root="+target+"'");        
        });
    }
    ...
    private void initComponents()
    {
        ...
        Platform.runLater(() ->
        {
            ...
            webEngine.load("http://127.0.0.1:8081/sample.html?root=contracts");
        });
    }
    ...
    public class ApiBridge
    {
        ...
        {
            final Contract contractJava = ModelConverter.contractFrom(contract);
